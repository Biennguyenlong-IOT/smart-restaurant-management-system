      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-24 px-1">
        {activeTab === 'DASHBOARD' && (
           <div className="space-y-6">
              ...
              >
                <Trash2 size={16}/> Xoá lịch sử doanh thu (Kết toán)
              </button>
           </div>
        )}
              ...
              <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
                 <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-[9px] font-bold text-slate-400 uppercase italic mt-1">Ghi nhận từ đánh giá của khách hàng</p>
                    </div>
                    <button 
                    ...
                    <table className="w-full text-left">
                       <thead>
                          <tr className="border-b border-slate-50">
                             ...
                             <th className="pb-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Ghi nhận</th>
                             <th className="pb-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Điểm KPI</th>
                          </tr>
                       </thead>
                             ...
                             <tr key={s.id}>
                                ...
                                <td className="py-4 text-center">
                                   <span className="text-[10px] font-black text-slate-700 italic">
                                     {s.role === UserRole.KITCHEN ? `${s.reviewCount} lượt món` : `${s.orderCount} bàn`}
                                   </span>
                                </td>
                                <td className="py-4">
                                   <div className="flex flex-col items-center">
                                      ...
                                      <p className="text-[7px] font-black text-slate-300 uppercase italic">
                                        {s.role === UserRole.KITCHEN ? 'KPI Món Ăn' : 'KPI Phục Vụ'}
                                      </p>
                                   </div>
                                </td>
                             </tr>
        ...
        {activeTab === 'CLOUD' && (
           <div className="max-w-md mx-auto space-y-6">
              ...
              <div className="bg-red-50 p-10 rounded-[3rem] border-2 border-dashed border-red-100">
                 ...
                 <h4 className="text-center font-black text-lg uppercase italic mb-8 text-red-600">Bảo trì dữ liệu (Danger Zone)</h4>
                 <div className="space-y-3">
                    <button 
